...
- `--dimension <name>` **(required)** — one of:
  ...
  - **slice-breakdown dimension** (a slice map): `designability`. (Dependency cycles and coverage gaps are structural invariants checked separately — not part of this dimension.)
