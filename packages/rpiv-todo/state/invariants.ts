...
export const VALID_TRANSITIONS: Record<TaskStatus, ReadonlySet<TaskStatus>> = {
	pending: new Set(["in_progress", "failed", "awaiting_user", "completed", "deleted"]),
	in_progress: new Set(["pending", "failed", "awaiting_user", "completed", "deleted"]),
	failed: new Set(["in_progress", "awaiting_user", "completed", "deleted"]),
	awaiting_user: new Set(["in_progress", "failed", "completed", "deleted"]),
