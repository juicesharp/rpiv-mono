...
- Completed questionnaires now render a compact, localized receipt containing only the submitted answer values. The full model-facing response remains available in the expanded tool view, while validation and runtime errors continue to show their complete message.
